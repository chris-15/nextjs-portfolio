...
function ProjectItem({
  ...
  return (
    <div className="relative flex items-center justify-center h-full w-full rounded-xl p-4 group hover:bg-gradient-to-r from-[#1b1c1c] to-[#323036] ">
      <Image
        src={backgroundImg}
      ...
      <div className="hidden group-hover:block absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] ">
        <div className="flex flex-col items-center">
          ...
          <p className="pb-4 pt-2 text-white text-center text-sm sm:text-base">
            {description}
          </p>
          <div className="flex space-x-4 text-black">
            <a href={projectUrl} target="_blank" rel="noopener noreferrer">
              <FaLink
                size={50}
                className="bg-white rounded-lg p-3 transition-all duration-300 hover:bg-neutral-400"
              />
            </a>
  ...
  const projectsList = [
    {
      title: "Cod Dashboard",
      description:
        "A Next.js dashboard application where users can record and analyze their Call of Duty Ranked match statisitcs.",
    ...
    },
    {
      title: "RentAFit",
      description:
        "MERN stack application where users can post clothing items to rent or search items to rent.",
    ...
    },
    {
      title: "Journey",
      description:
        "MERN stack application where users can post about their cancer treatment journeys.",
    ...
    },
    {
      ...
      description:
        "A weather dashboard web application where users can search for the weather information of their favorite city.",
